...
class _ForgetPasswordState extends State<ForgetPassword> with TickerProviderStateMixin {
  ...
  final TextEditingController _forgetPasTextController = TextEditingController(text: '');
  @override
  void dispose() {
 ...
 void _forgetPassSubmitForm() async
 {
  try
  {
    ...
    email: _forgetPasTextController.text,
    );
        ...
        children: [
          ...
          child: ListView(
            ...
            const SizedBox(height: 10,),
              ...
              TextField(
                controller: _forgetPasTextController,
              ...
              MaterialButton(
                  onPressed: ()
                      {
                        //create forget passwordSubmitForm
